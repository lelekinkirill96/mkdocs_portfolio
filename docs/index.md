...
"Cлепые зоны" - Это устройства, сервисы или сегменты сети, которые не учтены в системах мониторинга, CMDB или Active Directory. Они возникают по следующим причинам:
...
## 1. Первичная инвентаризация: создание эталонного слепка (baseline) сети
