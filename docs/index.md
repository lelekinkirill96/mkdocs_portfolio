...
3. **Новые устройства** — серверы, сетевое оборудование или виртуальные машины, добавленные в обход процессов ИТ-отдела.

4. **Изолированные сегменты** — DMZ, промышленные сети (OT), облачные инфраструктуры, которые не сканируются регулярно.

5. **Устаревшие записи** — устройства, давно выведенные из эксплуатации, но всё ещё числящиеся в документации.
